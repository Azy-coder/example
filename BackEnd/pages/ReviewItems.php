 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">The Administrator</a>
        </div>
      </div>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                   Items Uploaded by the User's. Need to Review and appoval before posting
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><button class="btn btn-primary post" value="<?php echo $rows[0]; ?>" >POST</button>
